 ...
 <html class="no-js"> <!--<![endif]-->
	...
	<script>
		$('.user_name').click(function(){
            ...
            var credits=<?php echo $_GET['credits'];?>;
			var id2 = $(this).parent().children()[0].innerHTML
			console.log($(this).parent().children().innerHTML)
			window.location.href="updates.php?userid="+id+"&userid2="+id2+"&credits="+credits
		})
	</script>
	<style>
		.user_name
